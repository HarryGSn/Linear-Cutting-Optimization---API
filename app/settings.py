"""
Django settings for optimizations project.
...
SECRET_KEY = 'django-insecure-n6in+#ia-gyie@#1qo*-+6fo=x#kh0+^wc9+o5wab!ycv%5^qi'
...
INSTALLED_APPS = [
    ...
    # 'app.models', # no models in app required, we'll split it in apps inside our project
    'rest_framework',
